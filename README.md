...
The full process and justifications can be found here: [Pre-Cleaning SQL Queries](./cyclistic-bike-share-analysis/SQL/pre_cleaning_SQL.txt)
...
The full process and justifications can be found here: [Cleaning Queries](./cyclistic-bike-share-analysis/SQL/cleaning_phase_SQL.txt)
